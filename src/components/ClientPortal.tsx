...
export default function ClientPortal({
  ...
  const [portalSubTab, setPortalSubTab] = useState<'profile' | 'requests' | 'invoices' | 'databases' | 'workspace' | 'team' | 'contracts' | 'financials' | 'dashboard'>('dashboard');
                ...
                <div className="flex items-center space-x-2.5 rtl:space-x-reverse self-stretch sm:self-auto justify-between sm:justify-end">
                  {currentClient && (
                    <button
                      type="button"
                      onClick={onLogout}
                      className="px-4 py-2 rounded-xl bg-red-50 text-red-600 border border-red-100 hover:bg-red-100/50 text-xs font-black transition-all flex items-center gap-1.5 cursor-pointer"
